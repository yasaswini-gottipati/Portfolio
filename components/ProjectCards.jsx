  ...
  return (
    <Card className='group overflow-hidden relative'>
      <CardHeader className='p-0'>
        ...
        justify-center bg-tertiary dark:bg-secondary/40 xl:bg-work_project_bg_light 
        xl:dark:bg-work_project_bg_dark xl:bg-[110%] xl:bg-no-repeat overflow:hidden'>
            ...
            <Link href={project.link} className='bg-secondary w-[54px] h-[54px] rounded-full flex 
            ...
            <Link href={project.github} className='bg-secondary w-[54px] h-[54px] rounded-full flex 
            justify-center items-center scale-0 opacity-0 group-hover:scale-100 
